...
const NewEvent = () => {
  return (
    <div className="view">
      <br />
      NewEvents <br />
      facilis, quae magnam, totam deleniti laudantium modi perferendis. Amet
      ...
      provident numquam quas v quas veniam sit voluptate ratione. Alias,
      ...
      Dicta, beatae. Vitae, nostrum dolores illum maiores provident numquam quas
      veniam sit voluptate ratione. Alias, corporis! Quasi sequi voluptate
      voluptatibus rerum esse, deleniti tempore culpa enim inventore error,
      dolorem odit cupiditate magnam officia i repellendus, perspiciatis
      laudantium inventore laborum numquam obcaecati nulla est nemo consectetur
      accusamus! Cumque, est natus error atque labore repellat architecto
      perferendis exercitationem numquam nam fuga neque facilis, asperiores, rem
      quis iste.
    </div>
  );
};
